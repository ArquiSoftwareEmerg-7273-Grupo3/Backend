...
public record ProyectoResource(Long id, Long escritorId, String titulo, String descripcion,
							   @JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss") @Schema(type = "string", example = "2025-11-12T17:12:04", description = "Fecha y hora del inicio") LocalDateTime fechaFin,@JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss") @Schema(type = "string", example = "2025-11-12T17:12:04", description = "Fecha y hora del inicio") LocalDateTime fechaInicio,BigDecimal presupuesto,EstadoProyecto estado, ModalidadProyecto modalidadProyecto, ContratoProyecto contratoProyecto, EspecialidadProyecto especialidadProyecto, String requisitos,Integer maxPostulaciones) {
